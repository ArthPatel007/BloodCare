...
if (isset($_POST['submit'])) {
    ...
    $insertquery = "insert into recipient(FullName,Gender,BloodGroup,age,MobileNumber,email,city,pincode,password) values
    ('$fullname','$gender','$bloodgroup','$age','$mobile','$email','$city','$pincode','$password')";
...
<body>
    ...
    <div class="blood-bank-form">
        ...
        <h1 style="color: #c20e0e">Recipient Registration</h1>
        <form id="registration-form" action="#" method="POST">
            ...
            <input type="text" id="pincode" name="pincode" placeholder="Pincode" pattern="\d{6}" title="Please enter a 6-digit PIN code" required />
            ...
            <p class="account-w3ls text-center pb-4" style="color:#000">
                Already Registered?
                <a href="recipientlogin.php">Signin now</a>
            </p>
        </form>
    </div>
