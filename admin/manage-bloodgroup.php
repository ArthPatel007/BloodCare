...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_GET['del'])) {
		...
		if ($result) {
			...
			$error = "Something went wrong with the query execution. Please try again";
		}
	}
?>
	...
	<head>
		...
		<title>BloodCare |Admin Manage Blood groups </title>
										...
										<tbody>
											...
											?>
													<tr>
														...
														<td>
															<a href="manage-bloodgroup.php?del=<?php echo $row['id']; ?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a>
														</td>
													</tr>
											<?php
													$cnt = $cnt + 1;
