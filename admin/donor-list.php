...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_REQUEST['del'])) {
		$did = intval($_GET['del']);
		$sql = "DELETE FROM donor WHERE id = '$did'";
										...
										<tbody>
											...
											?>
													<tr>
														...
														<td>
															<a href="donor-list.php?del=<?php echo htmlentities($row['id']); ?>" onclick="return confirm('Do you really want to delete this record')" class="btn btn-danger" style="margin-top:1%;">Delete</a>
														</td>
													</tr>
											<?php
													$cnt = $cnt + 1;
